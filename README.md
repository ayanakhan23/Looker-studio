App Insights Unlocked – Google Play Store Analysis 

Project Overview -
App Insights Unlocked is a data analytics case study focused on analyzing Google Play Store application data to uncover key factors that drive app success. This project was completed
entirely using Looker Studio, with the goal of transforming raw app data into meaningful, business-ready insights through interactive dashboards and visual storytelling.
The analysis helps stakeholders understand user behavior, app performance, and market trends to support data-driven decisions in app development, marketing, and monetization strategies.

Business Problem -
The company wanted to answer critical questions such as:
What factors contribute to high app ratings and installs?
Which app categories and genres perform best?
How do app size, pricing, and type (Free vs Paid) affect user engagement?
What user preferences can be inferred from ratings, reviews, and content ratings?
